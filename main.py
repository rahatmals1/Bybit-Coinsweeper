...
class ByBitGameBot:
    ...
    def run(self):
        ...
        print(f"{Fore.CYAN + Style.BRIGHT}>>> ByBit Game Bot <<< ")
        print(f"{Fore.GREEN + Style.BRIGHT}>>> Credit:- RahatMals <<<")
        print(f"{Fore.BLUE + Style.BRIGHT}>>> Telegram Channel:- https://t.me/InstantEarning169 ")
        print(f"{Fore.RED + Style.BRIGHT}========================================")
